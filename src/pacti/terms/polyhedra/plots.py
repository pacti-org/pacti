...
def plot_guarantees(
    ...
    x_transform: Optional[Callable[[numeric], numeric]] = None,
    y_transform: Optional[Callable[[numeric], numeric]] = None,
    ...
    if x_transform is not None and y_transform is not None:
        fig = _plot_transformed_constraints(contract.a | contract.g, x_var, y_var, var_values, x_lims, y_lims, new_x_var, new_y_var, x_transform, y_transform, number_of_points)
    else:
