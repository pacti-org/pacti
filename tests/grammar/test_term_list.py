...
class TestTermList(unittest.TestCase):
    ...
    def test_abs_term1(self) -> None:
        t0 = pp.ParseResults(PolyhedralSyntaxAbsoluteTerm(
            term_list=PolyhedralSyntaxTermList(constant=3.0, factors={}),
            coefficient=None))
    ...
    def test_abs_term2(self) -> None:
        t0 = pp.ParseResults(PolyhedralSyntaxAbsoluteTerm(
            term_list=PolyhedralSyntaxTermList(constant=0, factors={'x': 3.0}),
            coefficient=4.0))
    ...
    def test_parse5b1(self) -> None:
        t0 = pp.ParseResults(PolyhedralSyntaxAbsoluteTermList(
    ...
    def test_parse6a(self) -> None:
        t0 = pp.ParseResults(PolyhedralSyntaxAbsoluteTermList(
            ...
            absolute_term_list=[PolyhedralSyntaxAbsoluteTerm(
                coefficient=None,
